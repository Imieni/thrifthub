...
var KTAppEcommerceProducts=function(){
    var t,e,n,r=()=>{
        e.querySelectorAll('[data-kt-ecommerce-product-filter="delete_row"]').
        forEach((t=>{
            t.addEventListener("click",(function(t){
                t.preventDefault();
                const e=t.target.closest("tr"),
                r=e.querySelector('[data-kt-ecommerce-product-filter="product_name"]').
                innerText;Swal.fire({
    ...
    return{
        init:function(){
            ...
            e=document.querySelector(t),(n=new DataTable(t,{
                info:!1,
                order:[],
                pageLength:10,
                columnDefs:[
